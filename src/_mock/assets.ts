...
const INVENTORY_PERMISSION = {
	...
	children: [
		{
			id: "1000000000000002",
			parentId: "1000000000000001",
			label: "sys.nav.inventory.categories",
			name: "Categories",
			type: PermissionType.MENU,
			route: "categories",
			component: "/pages/inventory/categories.tsx",
		},
		{
			id: "1000000000000003",
			parentId: "1000000000000001",
			label: "sys.nav.inventory.units",
			name: "Units",
			type: PermissionType.MENU,
			route: "units",
			component: "/pages/inventory/units.tsx",
		},
		{
			id: "1000000000000004",
			parentId: "1000000000000001",
			label: "sys.nav.inventory.products",
			name: "Products",
			type: PermissionType.MENU,
			route: "products",
			component: "/pages/inventory/products.tsx",
		},
		{
			id: "1000000000000005",
			parentId: "1000000000000001",
			label: "sys.nav.inventory.stock_management",
			name: "Stock Management",
			type: PermissionType.MENU,
			route: "stock-management",
			component: "/pages/inventory/stock-management.tsx",
		},
	],
};

const SALES_PERMISSION = {
	id: "2000000000000001",
	parentId: "",
	label: "sys.nav.sales.index",
	name: "Sales",
	...
	children: [
		{
			id: "2000000000000002",
			parentId: "2000000000000001",
			label: "sys.nav.sales.pos",
			name: "Point of Sale",
			type: PermissionType.MENU,
			route: "pos",
			component: "/pages/sales/pos.tsx",
		},
		{
			id: "2000000000000003",
			parentId: "2000000000000001",
			label: "sys.nav.sales.kds",
			name: "Kitchen Display",
			type: PermissionType.MENU,
			route: "kds",
			component: "/pages/sales/kds.tsx",
		},
		{
			id: "2000000000000004",
			parentId: "2000000000000001",
			label: "sys.nav.sales.orders",
			name: "Orders",
			type: PermissionType.MENU,
			route: "orders",
			component: "/pages/sales/orders/index.tsx",
		},
		{
			id: "2000000000000005",
			parentId: "2000000000000001",
			label: "sys.nav.sales.customers",
			name: "Customers",
			type: PermissionType.MENU,
			route: "customers",
			component: "/pages/sales/customers/index.tsx",
		},
		{
			id: "2000000000000006",
			parentId: "2000000000000001",
			label: "sys.nav.sales.tax_config",
			name: "Tax Configuration",
			type: PermissionType.MENU,
			route: "tax-config",
			component: "/pages/sales/tax-config.tsx",
		},
	],
};
