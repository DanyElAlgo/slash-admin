...
export const DB_MENU: Menu[] = [
	...
	},
	{
		...
		parentId: "inventory",
		name: "sys.nav.inventory.dashboard",
	...
	},
	{
		...
		parentId: "inventory",
		name: "sys.nav.inventory.categories",
		code: "inventory:categories",
		type: MENU,
		path: "/inventory/categories",
		component: "/pages/inventory/categories",
	},
	{
		id: "inventory_units",
		parentId: "inventory",
		name: "sys.nav.inventory.units",
		code: "inventory:units",
		type: MENU,
		path: "/inventory/units",
		component: "/pages/inventory/units",
	},
	{
		id: "inventory_products",
		parentId: "inventory",
		name: "sys.nav.inventory.products",
		code: "inventory:products",
		type: MENU,
		path: "/inventory/products",
		component: "/pages/inventory/products",
	},
	{
		id: "inventory_stock_management",
		parentId: "inventory",
		name: "sys.nav.inventory.stock_management",
		code: "inventory:stock_management",
		type: MENU,
		path: "/inventory/stock-management",
		component: "/pages/inventory/stock-management",
	},
	{
		id: "sales",
		parentId: "group_dashboard",
		name: "sys.nav.sales.index",
		code: "sales",
	...
	},
	{
		id: "sales_orders",
		parentId: "sales",
		name: "sys.nav.sales.orders",
		code: "sales:orders",
		type: MENU,
		path: "/sales/orders",
		component: "/pages/sales/orders",
	},
	{
		id: "sales_customers",
		parentId: "sales",
		name: "sys.nav.sales.customers",
		code: "sales:customers",
		type: MENU,
		path: "/sales/customers",
		component: "/pages/sales/customers",
	},
	{
		id: "sales_payments",
		parentId: "sales",
		name: "sys.nav.sales.payments",
		code: "sales:payments",
		type: MENU,
		path: "/sales/payments",
		component: "/pages/sales/payments",
	},
	{
		id: "sales_tax_config",
		parentId: "sales",
		name: "sys.nav.sales.tax_config",
		code: "sales:tax_config",
		type: MENU,
		path: "/sales/tax-config",
		component: "/pages/sales/tax-config",
	},
	{
		id: "sales_pos",
		parentId: "sales",
		name: "sys.nav.sales.pos",
		code: "sales:pos",
		type: MENU,
		path: "/sales/pos",
		component: "/pages/sales/pos",
	},
	{
		id: "sales_kds",
		parentId: "sales",
		name: "sys.nav.sales.kds",
		code: "sales:kds",
		type: MENU,
		path: "/sales/kds",
